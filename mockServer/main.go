...
// WHEN CALLED, HAS TO BEGIN THE LOOP AND WAIT FOR THE SHUTDOWN OR STOP COMMAND

// RIGHT NOW, WHAT HAPPENS IS, THE TMUX STARTS THE PROGRAM, BUT SINCE THERE IS NO PARAMETER, IT JUST CLOSES
